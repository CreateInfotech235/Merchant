...
import crossmark from "../../assets_admin/crossmark.png";
import searchIcon from "../../assets_admin/search.png";
import WithdrawPopup from "../../Components_admin/WithdrawPopup/WithdrawPopup";
import Pagination from "../../Components_admin/Pagination/Pagination";
import { getApprovedWithdraw } from "../../Components_admin/Api/User"; // Assuming this is the API
...
const Approved = () => {
  ...
  const fetchApprovedRequest = async () => {
    const response = await getApprovedWithdraw(currentPage, requestsPerPage); // Fetching from API
    if (response.status) {

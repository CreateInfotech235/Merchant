...
import deliveryloc from "../../assets_admin/deliveryloc.png";
import pickup from "../../assets_admin/pickup.png";
import accepted from "../../assets_admin/accepted.svg";
import assigned from "../../assets_admin/assigned.svg";
import arrived from "../../assets_admin/arrived.svg";
import pickedup from "../../assets_admin/picked-up.svg";
import departed from "../../assets_admin/departed.svg";
import { getOrderLocation } from "../../Components_admin/Api/Order";
...
const OrderLocation = () => {
  ...
  const fetchLoaction = async() => {
    const res = await getOrderLocation();
  ...
  return (
    <>
      <div className="d-flex justify-content-end">
        <button
          type="button"
          className="pickup-location p-1 border-0 text-light m-3 rounded-2"
        >

...
const AboutUs = () => {
  return (
    ...
    <input type="text" className="app-name w-100 border-0 rounded-2 p-4 mb-3" style={{border:"1px solid #E6E6E6"}}/><br/>
    <label class="p-0 mb-3 text-black-50">subtitle</label><br/>
    <input type="text" className="app-name w-100 border-0 rounded-2 p-4 mb-3"  style={{border:"1px solid #E6E6E6"}} /><br/>
    <label class="p-0 mb-3 text-black-50">sort description</label><br/>
    <input type="text" className="app-name w-100 border-0 rounded-2 p-5 mb-3"  style={{border:"1px solid #E6E6E6"}} /><br/>

...
import { getPendingWithdraw } from "../../Components_admin/Api/User"; // Assuming this is the API
...
const Pending = () => {
  ...
  const fetchPendingRequests = async () => {
    const response = await getPendingWithdraw(currentPage, requestsPerPage); // Fetching from API
    if (response.status) {

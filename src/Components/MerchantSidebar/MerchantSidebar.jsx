  ...
  return (
    <>
      ...
      <div className={`col-xxl-2 col-xl-2 p-3 overflow-y-scroll position-fixed h-100 ${isSidebarVisible ? "sidebar visible" : "sidebar"}`}>
        <div className="col-xs-3 mt-5 mb-3 ms-3 me-3 bg-red-300">
          <Link to="/" className="d-flex items-center justify-content-center align-items-center text-white">
        ...
        <ul>
          ...
          <li className="my-2">
            ...
            >
              <span className="icon pe-4">
                <img src={parcel} style={{ width: "25px" }} alt="order" />
              </span>
              Orders

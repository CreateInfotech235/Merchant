...
const ProfilePage = () => {
  ...
  return (
    <>
      {loading ? (
        <div className="w-full flex justify-center min-h-[calc(100vh-187px)] items-center">
        ...
        <div className="min-h-screen bg-gradient-to-br via-white to-purple-50 py-12 px-4 sm:px-6 lg:px-8">
          <div className="max-w-8xl mx-auto">
            ...
            <div className="relative bg-white rounded-3xl overflow-hidden">
              {/* Background Pattern */}
              <div className="h-48  bg-gradient-to-r from-blue-500 to-purple-600 flex justify-center items-center pattern-dots pattern-blue-500 pattern-bg-white pattern-size-4 pattern-opacity-20">
                <div className=" relative rounded-full flex justify-center items-center m-auto shadow-xl  border-4 bg-white border-white w-32 h-32">
                  <img
                    src={merchant.image || defaultProfileImage}
                    alt="Profile"
                    className="w-32 m-auto rounded-full object-cover"
                  />
                  <Link
                    to={{ pathname: "/update-profile" }}
                    state={{ merchant }}
                    className="absolute  bottom-1 right-1 shadow-lg bg-[#3f83f8] hover:bg-[#5a96ff] text-[#fff] rounded-full p-2"
                  >
                    <FaPen size={14} />
                  </Link>
                </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-center space-x-4 p-4 bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow">
                    ...
                    <div>
                      ...
                      <p className="font-medium">
                        {merchant.medicalCertificateNumber || "N/A"}
                      </p>
                    </div>
                  </div>

                  <div className="p-4 bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow">
                    <p className="text-sm text-gray-500 mb-2">Company Registration Document</p>
                    <img

...
const MerchantSidebar = () => {
  ...
  const pageList2 = [
    ...
    { 
      ...
      isdrpdown: true,
      isactive: false,
      subTitle: ["Create Order", "All Order", "Order Location", "Trashed Order"],
      mainTitle: "Order",
      isIcon: true,
      icon: <LuBoxes style={{ fontSize: "27px", color: "#fff", fontWeight: "lighter" }} alt="order" />
    },
    { 
      ...
      isdrpdown: true,
      isactive: true,
      mainTitle: "Multi Order",
      subTitle: ["Create Order", "All Order", "Trashed Order"],
      isIcon: true,
      icon: <LuBoxes style={{ fontSize: "27px", color: "#fff", fontWeight: "lighter" }} alt="order" />
    },
    { 
      ...
      isdrpdown: false,
      isactive: true,
      mainTitle: "Multi Order Parcel",
      subTitle: ["Multi Order Parcel"],
      isIcon: true,
      icon: <BsBoxSeam style={{ fontSize: "27px", color: "#fff", fontWeight: "lighter" }} alt="order" />
    },
    { 
      ...
      isactive: false,
      mainTitle: "Customer",
      subTitle: ["All Customer", "Add Customer", "Trashed Customer"],
      isIcon: false,
      icon: <img src={customer} style={{ width: "25px" }} alt="customer" />
    },
    { 
      ...
      isdrpdown: true,
      isactive: true,
      mainTitle: "Delivery Man",
      subTitle: ["Delivery Man", "Add Delivery Man", "Delivery Man Location", "Delivery Man Trashed"],
      isIcon: true,
      icon: <img src={man} style={{ width: "25px" }} alt="delivery" />
    },
    { 
      ...
      isactive: true,
      mainTitle: "Support",
      subTitle: ["Show List Of Support Ticket"],
      isIcon: true,
      icon: <img src={support} style={{ width: "25px" }} alt="offers" />
    },
    { 
      path: ["/invoice-format"],
      num: 8,
      ...
      isactive: true,
      mainTitle: "Invoice",
      subTitle: ["Invoice Format"],
      isIcon: true,
      icon: <LiaFileInvoiceDollarSolid style={{ fontSize: "27px", color: "#fff" }} alt="order" />
    },
    { 
